 ...
 */
@Data
@TableName("ddf_pl_orderdetail")
@ApiModel(value="ddf_pl_orderdetail对象", description="计划明细")
public class DdfPlOrderdetail implements Serializable {
